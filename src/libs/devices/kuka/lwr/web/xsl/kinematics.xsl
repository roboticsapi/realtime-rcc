...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/kinematics">
		<div id="navi"><a href="./">FRI Controller</a></div>
		...
		<tr>
			<th>Joint 7</th>
			<td><xsl:value-of select="joints/@j7" /></td>
			<td><input type="text" name="j7"><xsl:attribute name="onfocus">if(this.value=="") this.value="<xsl:value-of select="joints/@j7" />";</xsl:attribute></input></td>
		</tr>
		...
		<tr>
			<th>Alpha</th>
			<td><xsl:value-of select="frame/@alpha" /></td>
			<td><input type="text" name="alpha"><xsl:attribute name="onfocus">if(this.value=="") this.value="<xsl:value-of select="frame/@alpha" />";</xsl:attribute></input></td>
		</tr>
		</table>
