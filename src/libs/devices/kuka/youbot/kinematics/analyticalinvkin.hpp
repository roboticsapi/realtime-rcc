...
namespace kuka_youbot
{
	 ...
	 */
	class RTT_EXPORT ArmAnalyticalInverseKinematics
	{
	public:
		/**
		 * Ctor.
	...
	private:
		 ...
		 */
		KDL::JntArray ik(const KDL::Frame& frame, bool offset_joint_1 = false, bool offset_joint_3 = false,
				bool offset_joint_5 = false);
