...
namespace canopen
{
	...
	extern "C"
	{
		...
		void RTT_EXPORT load(RPI::ExtensionLoaderInfo info)
		{
			...
			info.registerDeviceInterface<CanOpenInterface>("canopen", ext_canopen, HTTPHandlerList());
			info.registerDeviceInterface<CanOpenMasterInterface>("canopenmaster", ext_canopen, HTTPHandlerList());
		}
