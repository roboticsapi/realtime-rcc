...
namespace rtsocketcan
{
	...
	const std::string dev_rtcan = "rtsocketcan";

	class RtSocketCanDevice: public RPI::Device, public can::CanDevice, public RTT::TaskContext
	{
	public:
		RtSocketCanDevice(std::string name, RPI::parameter_t parameters);
		virtual ~RtSocketCanDevice();

		static RtSocketCanDevice* createDevice(std::string name, RPI::parameter_t parameters);
