...
#ifndef COMMUNICATIONLOGGER_HPP_
#define COMMUNICATIONLOGGER_HPP_
...
namespace communicationlogger
{
	...
	public:
		...
		void log(const can::CanMessage* message, bool received);
	...
	private:
		...
		int buf_start_pos;
		int buf_write_pos;
		ProtocolEntry debug_buffer[buf_size];

		int id_read;
		static const int countdown = 20;
		int stopAfterMessages;
...
#endif /* COMMUNICATIONLOGGER_HPP_ */
